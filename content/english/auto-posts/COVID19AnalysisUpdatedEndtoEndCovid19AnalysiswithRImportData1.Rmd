---
title: COVID 19 AnalysisUpdated   End to End Covid 19 Analysis with R   Import Data  1 
date: 2020-03-21
categories:
  - COVID-19 Analysis
tags:
...
<a href="https://www.youtube.com/watch?v=cdFIlaKKbkk">
<img src="auto-posts/images/58-AbsoluteBeginnersGuide-RStudiotoGithubtoNetlifyLiveSiteblogdownHugo.mp4.jpg">
</a>
...
if you scroll down on this website which
...
call this Kovac case whatever you want to name it what about my desktop create
...
and I'm making this very simples to keep this tutorial very short obviously you
...
need for this so first I want you to click on packages go to install let's do
...
so we'll just call it URL 1 and I'm gonna I'm gonna assign it to some sort
...
we're gonna say hey I want URL one that I just loaded into memory I'm gonna
...
temporary file into memory so let's go ahead and do my data frame kovat data
...
excel it would be read underscore xlsx I hope that's not too confusing but in a
...
we've done that now let's create one called
...
total now we're not gonna get to the analysis in this one but what I want to
...
to somebody or upload it so here it is we have all of our stuff here and as you
...
out and I appreciate that [Music] you [Music]End of file
