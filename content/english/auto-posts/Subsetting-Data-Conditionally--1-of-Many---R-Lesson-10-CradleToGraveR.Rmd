---
title: Absolute Beginners Guide - Subsetting Data Conditionally  1 of Many   R Lesson 10 CradleToGraveR
date: 2019-08-28
categories:
...
w3codecolor: false
draft: false
thumbnail: https://i.ytimg.com/vi/yHmD7g-lsr4/maxresdefault.jpg
---

<a href="https://www.youtube.com/watch?v=yHmD7g-lsr4">
<img src="auto-posts/images/11-AbsoluteBeginnersGuide-SubsettingData(dataframe),1ofMany-RLesson9.webm.jpg">
</a>
...
gonna have to learn to use Google and Stack Overflow but by practicing these
...
idea of guess what this data is we really don't know what kind of data is
...
of the headers right here so we want to know if there's any petal widths
...
point 4 1 and it has to have a let's say let's go up to the top here and look at
...
and here they are here the outputs well if you want to save that something you
...
the pipe which is above the return key usually and a shift or we want plant
...
is this entire thing which leads to a vector of trues and falses and that's
...
of them throughout the entire lesson set see you in the next lessonEnd of file
