---
title: Absolute Beginners Guideggplot Labels and Titles  markdown tabs   R Lesson 12 CradleToGraveR
date: 2019-09-17
categories:
...
<a href="https://www.youtube.com/watch?v=1QYgccXBtrI">
<img src="auto-posts/images/13-AbsoluteBeginnersGuide-ggplotScatterPlot,geom_point(firstplot)-RLesson11CradleToGraveR.webm.jpg">
</a>
...
gonna show you a little trick with us our markdown as well that I didn't show
...
close this out we're not going to really
...
make that a little bit smaller so you can view it better now we don't want
...
actual tick marks on there five six seven eight and two four six all right
...
else another variable so I'm going to call this my scatter plot right set that
...
we'll call the scatter plot no title just for fun because I want to show you
...
instead of doing load libraries and scatter plots in this in this manner
...
again open in web browser and again I'll bring it over and you're not gonna see
...
yellow information bar there it says title subtitle caption etc etc
...
don't forget and then now any second level header so second level header will
...
the moment so so cool we have our second tab with the my scatterplot label let's
...
and we're gonna say title equals my title but this time we will add the axes
...
that is not from the iris or not from the standard data sets that come with
