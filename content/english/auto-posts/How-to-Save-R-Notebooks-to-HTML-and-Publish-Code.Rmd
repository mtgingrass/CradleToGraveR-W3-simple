...
<a href="https://www.youtube.com/watch?v=_ffu_LO53UQ">
...
easy to access within your environment so save that as test one and it's
...
file I can send it to my friends and literally they can hit the Run button
...
to do is we want to let's go ahead and change lines 13 through 17 as well and
...
slight difference so if I click on that and I go to open in browser view in web
...
all kinds of parameters we'll get into well I just wanted to show you how to do
...
this is important this this is actually very subtle but very important and we
...
so it did happen in our HTML I'm not sure why oh because you have to save it
...
them for sure check them out below and I'll see you in the next videoEnd of file
