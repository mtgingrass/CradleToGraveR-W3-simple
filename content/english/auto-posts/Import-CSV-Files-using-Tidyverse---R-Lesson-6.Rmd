---
title: Absolute Beginners Guide - Import CSV Files using Tidyverse   R Lesson 6
date: 2019-08-10
categories:
...
<a href="https://www.youtube.com/watch?v=Pa-DuVzrGMo">
<img src="auto-posts/images/07-AbsoluteBeginnersGuide-RNotebooks-Lesson5.mp4.jpg">
</a>
...
pipe that water into a house you can pipe it into a container you could take
...
pretty much on par with like metadata yeah Mille YAML you're going to hear
...
that's what the notebook file does so close that out let's go back to our now
...
ways to methods to do this well there's more than two but it'll start with two
...
command enter on a PC hit shift enter I believe or ctrl enter I forget and it's
...
default but we're not gonna get into that yet install dependencies that's
...
here it literally just typed in the same thing we did installed up packages see
...
that because it's no longer the output of that previous chunk I can get that
...
file comma separated so it's a spreadsheet that's all it is
...
of people respect his opinion and use it so let's go ahead and follow that for
...
want to water my plant so I would water it through the big pipe to my house out
...
form besides getting into ones and zeros
...
starts on Row 1 the header file is not actually the data and we go down to 50
...
went down to 50 observations so we're back to square one which is a more clean
...
I type in 50 houses well what if it's 51
...
it's got the code here you can hide them cool I mean this is why you love
...
spreadsheet itself it's actually just one row of data so it's a what it's
...
the R which is pretty nice all we're gonna do for this plot is type in the
...
view and I will see you in the next one youEnd of file
