---
title: Absolute Beginners Guide to Statistical ProgrammingRSS R Squared Math R RStudio
date: 2020-05-19
categories:
...
<a href="https://www.youtube.com/watch?v=j7L1cB1ILcI">
<img src="auto-posts/images/11-AbsoluteBeginnersGuidetoStatisticalProgramming-Residuals,Predictions,PlotsR.mp4.jpg">
</a>
...
accuracy you should kind of know what's going on at least a little bit right so
...
summation mark the sum of all of the Y eyes minus the average Y that's what
...
those dots so the actual number here the actual number here the number here the
...
our s is equal to the summation from I equals 1 to N of the actual the actual Y
...
here's your linear line here's your linear model that you just
...
I value then of course that numbers going to be smaller and smaller and at
...
right so hey you can kind of predict that right you add radio and TV you're
...
so in this channel this is my my name mark Jin grass just YouTube just look up
...
check out this channel I show you how to actually monetize and try to make money
...
guys helping me out [Music]End of file
