---
title: Absolute Beginners GuideHugo Blogdown Tutorial with R RStudio Customize Menus Layouts
date: 2020-06-09
categories:
...
<a href="https://www.youtube.com/watch?v=338jZbCVXcw">
<img src="auto-posts/images/54-AbsoluteBeginnersGuide-RHugoWebSiteLesson1.mp4.jpg">
</a>
...
site's let's go back to files here and make sure that you're in that project
...
something com right but let's not worry about that yet we're not there yet
...
will give you right here in Hugo and blog down will do the rest
...
more and click on clean all now before I do that again I showed you I have a
...
so I'm gonna click on build website again I'll do it up here so you can see
...
also does not look good that's because these sites require a server so we now
...
yeah it's all there you can leave this up if you want make changes or not the
...
the math settings it'll it'll do late a cork a tech so what have you want to
...
well figure that one out later too but I wanted to show you you can put your URL
...
they're not dropdowns there any things so let's see if I click on posts or
...
web and then we're going to use our which is right here and we're actually
...
make changes to your themes you would have to mess with this and we'll get
...
go there today but under layouts you're gonna have different things called
...
until you serve that site so don't get too alarmed about that so play around
...
other sites so just wanted to give you one quick update have a good oneEnd of file
