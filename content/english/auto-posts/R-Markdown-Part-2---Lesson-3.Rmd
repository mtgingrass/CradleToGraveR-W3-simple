---
title: Absolute Beginners Guide - R Markdown Part 2   Lesson 3
date: 2019-08-02
categories:
...
w3codecolor: false
draft: false
thumbnail: https://i.ytimg.com/vi_webp/j7Xo7xFA3Bg/maxresdefault.webp
---

<a href="https://www.youtube.com/watch?v=j7Xo7xFA3Bg">
<img src="auto-posts/images/04-AbsoluteBeginnersGuide-RMarkdown-Lesson2.mp4.jpg">
</a>
...
tables etc etc going back let's say that we don't want this link to be like that
...
now what we're gonna do is we're gonna knit this by clicking on that knit
...
right bracket we're gonna put in the word link and then right after it you're
...
to highlight it hold shift and hit the star and you'll notice a star shows up
...
plots had two levels or two head or two I believe this is header three and it
...
spaces you're gonna use one you're gonna have to go google this it's two spaces
...
pretty common so I wanted to make sure to show you all of those things there's
...
three perfectly lined up you can also do
...
actually knits to HTML pretty cool this is a regular HTML file what you do
