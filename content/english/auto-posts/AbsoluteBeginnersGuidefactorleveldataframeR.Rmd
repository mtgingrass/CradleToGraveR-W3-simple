---
title: Absolute Beginners Guidefactor level dataframe R
date: 2020-02-18
categories:
...
w3codecolor: false
draft: false
thumbnail: https://i.ytimg.com/vi_webp/_FtCMgFFK60/maxresdefault.webp
---

<a href="https://www.youtube.com/watch?v=_FtCMgFFK60">
<img src="auto-posts/images/24-AbsoluteBeginnersGuide-GGPLOT2&DPLYREnhancedPlotsusinggapminderData.mp4.jpg">
</a>
...
you could put a character string in there that's a different story
...
that so we have our our data OD and actually let's not call that OD let's
...
so we have some data that's all that matters and they all have the equal
...
it looks like it worked let's go ahead and click on it just to show you
...
factor let me give you an example because this is actually really
...
difference between them character strings will allow any other string to
...
want to show you something OD gender you're gonna see in the
...
comma now I want all the columns so I'm gonna leave that blank I could spell
...
factor level n/a generated so now let's look at our our data you see on level 8
...
called levels equals and that'll be a another vector we're gonna say hey we
...
that's it that's pretty good then there's ways to order them you can
...
forward and make more videos like this feel free to reference this video

00:12
anywhere on the Internet and thank you for watching and see you in the next one
you [Music]End of file
