---
title: Absolute Beginners GuideR Studio Shortcut Tips
date: 2020-01-15
categories:
...
<a href="https://www.youtube.com/watch?v=UfbBDJogwyQ">
<img src="auto-posts/images/19-AbsoluteBeginnersGuide-ScrapeRedditCommentsRExtractoR.mp4.jpg">
</a>
...
want to go back and forth between the editor and the console and you're
...
like control 5 you can see that it brought me to the files control 6 plots
...
testing or some troubleshooting you can do the option and then return key so if
...
helpful tip okay one other example that I want to show you real quick is how to
...
not anything below it because everything above it so control option B for
...
to clear the console window you can do ctrl + L so that will clear your console
...
forward to seeing you in the next videoEnd of file
