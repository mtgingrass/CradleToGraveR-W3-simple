---
title: Absolute Beginners GuideR Hugo Theme and Dynamic Changes
date: 2020-06-06
categories:
...
<a href="https://www.youtube.com/watch?v=fImF3Rd1GBA">
<img src="auto-posts/images/53-AbsoluteBeginnersGuide-dput-RReproducibleExampleforStackOverflow.mp4.jpg">
</a>
...
directory we can try using the blog down
...
this theme here right it's the Hugo lithium but it's under yih UI Hugo
...
whew the home page should be a github page and you can see I've got the author
...
studio and then once you have the build you can build it and do all these things
...
could find this here this little IP address useful so ctrl C on that bad boy
...
probably see it on the very bottom of my screen it's very small
...
everything is going to be treated equally and in another tutorial after
