---
title: Absolute Beginners Guide - Subsetting Data  data frame   1 of Many   R Lesson 9
date: 2019-08-22
categories:
...
<a href="https://www.youtube.com/watch?v=9zLDvEtGVaQ">
<img src="auto-posts/images/10-AbsoluteBeginnersGuide-RandomNumbers,Seeds-RLesson8.webm.jpg">
</a>
...
etc etc there's 11 different features or columns and then there's a bunch of
...
we're going to open up open bracket close bracket and just do 1 colon 3
...
these brackets 1 3 &amp; 5 so that's how you
...
I'm gonna type in 5 there and I'll get the first 5 there we go so now you can
...
exact thing as the head cars five so we got the first five rows or observations
...
first and the seventh row or the seventh row comma let's say we only wanted you
...
little bit about everything that works with functions data sets cars everything
...
look at these columns real quick we don't want miles per gallon to say
...
include only remember you can have anything inside of these get fancy with
...
the negative subset I guess you can call thatEnd of file
