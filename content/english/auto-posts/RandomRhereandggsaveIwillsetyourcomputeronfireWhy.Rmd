...
<a href="https://www.youtube.com/watch?v=RSXXYxCz630">
<picture><img src="https://i.ytimg.com/vi_webp/RSXXYxCz630/maxresdefault.webp"></picture>
</a>
...
and this PC so just just so I know we're going to find it create that project
...
our files and make sure we do it the correct way to a point so let's not put
...
script cool got that figured out now let's play with a couple examples and
...
it out let's go to our directories we have it right here in our base path the
...
raw folder so delete that again we screwed up data slash raw slash blah now
...
we on Linux that we on Mac going on PC Windows like what are we on so let's
...
we can break my data all day long start a fresh new on and create and then
...
without any forward slashes of back slashes congratulations now let's just
...
and now let's save it so we're gonna save this by doing GG sick doo doo doo
...
learned how to use the here package a little bit and how to save a tree tree
...
guys thanks for everything and as always I'll see you in the next video [Music]End of file
...
categories:
  - Random R
tags:
  - i will set your computer on fire
