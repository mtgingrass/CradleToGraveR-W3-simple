---
title: Absolute Beginners GuidePlot COVID 19 coronavirus Data using R dplyr and ggplot
date: 2020-03-23
categories:
...
<a href="https://www.youtube.com/watch?v=ioqrwUaSde8">
<img src="auto-posts/images/31-AbsoluteBeginnersGuide-KableTablewithRandCoronavirusCOVID19DeathRates.webm.jpg">
</a>
...
already seen the data you can actually look at it here click on DF and EDF you
...
are greater than 0 so now we're there in
...
by and they can type in countries and territories it automatically puts two
...
it now what am I gonna assign cases total the sum of all the cases I'm
...
country's one with the countries and territories and that's it for that and
...
it's like this so let's go ahead and run this and see if what kind of errors I
...
we can we can render this now let's save it remember command s our markdown
...
stylin we will first let's reduce that so let's just call this reduced EDF and
...
the lesson that didn't quite turn out as planned but I hope we learned something

00:09
from it [Music]End of file
