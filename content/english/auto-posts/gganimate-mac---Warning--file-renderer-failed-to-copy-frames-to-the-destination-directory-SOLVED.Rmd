...
<a href="https://www.youtube.com/watch?v=VfLRhPEuYDc">
...
thought okay going down going down here's a static plot and then it says
...
to write something to this folder that I think is not coming directly from our
...
multiple times within this window for example the first thing I started doing
...
literally like 5 or 6 times I was playing around with it so go to your
...
access and then I type in space and I put in the actual directory which is
...
able to get the plot and you can do this in an RM d file a notebook file you can
...
into these snags if you run into those snags hopefully this will help you fix it
...
please share comment and like and share this videoEnd of file
