---
title: Absolute Beginners Guideggplot Scatter Plot  geom point  first plot    R Lesson 11 CradleToGraveR
date: 2019-09-16
categories:
...
w3codecolor: false
draft: false
thumbnail: https://i.ytimg.com/vi_webp/gCAwHbmOqCo/maxresdefault.webp
---

<a href="https://www.youtube.com/watch?v=gCAwHbmOqCo">
<img src="auto-posts/images/12-AbsoluteBeginnersGuide-SubsettingDataConditionally,1ofMany-RLesson10CradleToGraveR.webm.jpg">
</a>
...
take a look at that first let's do a view and just type in diamond Oh
...
this we're not gonna change it so we can we don't have to store it in our RAM in
...
equal to the caret because that was one of the features and we'll say Y is equal
...
rows here we go so we said X is 2 carat and y is the
...
diamonds and then hit the dollar sign and then do cut and it should do the
...
let's do color actual color as a feature and see if we get anything good out of
...
pick a different data set remember we learned about the iris data set so let's
...
color equals and then do this and let's make the color the actual species
...
this but this will get you started on plot inEnd of file
