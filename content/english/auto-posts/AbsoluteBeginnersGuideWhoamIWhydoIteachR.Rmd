---
title: Absolute Beginners GuideWho am I  Why do I teach R 
date: 2020-05-25
categories:
...
<a href="https://www.youtube.com/watch?v=_D12UM7iP_Q">
<img src="auto-posts/images/50-AbsoluteBeginnersGuide-RInteractionTermsandRegression.mp4.jpg">
</a>
...
everything because I have my work computer that you can't plug things into
...
been seeing from this point on was usually through workarounds band-aids
...
stands for but all these shortcut keys to switch angles and switch views and
...
Windows GUI interfaces from base C++ you know well the Microsoft foundation
...
I would try it I would learn it I would make it work and then I would stop and
...
but I've been using it for another another server for trying to talk to
...
never did it in the real world but still learned all the concepts and a lot of
...
but anyways I learned are mostly through a course I took in college called I
...
predicted you know model or best model that can do the predictions so I'm not a
...
and they're all IT related or data related so I learned a lot about data
...
talking jargon they'll start talking some advanced you know vector
...
mean it's it's all over the place now R is good for research and quick data but
...
and I have to keep an eye on them as far
...
but yeah another thing is support vector machines will do some basic neural
...
would then take the rest of the data the 30 percent or sometimes people will
...
of it but I will definitely teach the basics of all of them so that you can
...
multitask and throw it in this chat as well let me find it up here it's OCD evl
...
it means by doing this right so that's all that's all I'm saying about that so
...
nowadays whatever it is and they're they strive to become that they want to like
...
those contracts but it has to fit a business need always and that's crucial you
...
as well but let's see I'm kind of all over the place now Oh C++ so I started
...
used to I would put him on like one-fourth the speed or something to try
...
run some visualizations and they do some
...
tutorials is the one where I scrape Twitter I think that's the one that
...
here's what I'm trying to do and I'm not very disciplined at it yet as you could
...
make like 30 bucks a month on skosh I don't
...
misconception but people always say it's a black box you don't know how that
...
slightly different code you have a different package version all of these
...
little sequences I finally put it together saying hey look no actually
...
rated comment or whatever read that before I even read the question I don't
...
gonna get a bad reputation so you got to really be careful with that Stack
...
and I will say if you're trying to stream online if you want the good
...
even teaching are like like I'm doing you know just start out if you teach it
...
answers to that but I don't so that's why I'm gonna start interviewing other
...
there's like an XLS X package or something
...
it takes up CPU cycles but it doesn't take up much space so if you you know to
...
to build up something there and that one is monetized by the way so let's see
...
all that stuff if you guys want to know about how much money my channels make
...
PI torch was taken over yeah I would love to do the interviews with anybody
...
infraction right so it was like sold to a minor sold to a minor what I was doing
...
you've noticed that but in your settings you can just click on the our version
...
hopefully we can find each other after this and make it happen let's do it the
...
the coordinates I'm kind of all over the place um reading comments and then just
...
one of my friends were like no no you're
...
more practical with real data let's start doing that I appreciate you guys
...
I love Python because every single industry uses it there's no doubt about it
...
and I will see you guys next timeEnd of file
