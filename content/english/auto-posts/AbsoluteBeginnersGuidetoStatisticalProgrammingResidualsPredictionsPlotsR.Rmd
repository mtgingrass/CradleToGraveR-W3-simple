---
title: Absolute Beginners Guide to Statistical ProgrammingResiduals  Predictions  Plots R
date: 2020-05-14
categories:
...
<a href="https://www.youtube.com/watch?v=DK11khHTMs0">
<img src="auto-posts/images/10-AbsoluteBeginnersGuidetoStatisticalProgramming-CorrelationMatrixinRwithcorplot.mp4.jpg">
</a>
...
last feature is carb so close that out and what we're gonna do is we're gonna
...
forget where there's certain error in in the actual data that you just cannot
...
see that I have predicted on the right hand side so miles per gallon was twenty
...
predicted is eight point seven so it's off by five point nine it's pretty high
...
error data must be a data frame oh I didn't add the data let's start with
...
play around that command enter and you'll see we should have error there's
...
and will make the size equal to the absolute value of the residuals as well
...
though the size is there the fact that it's red and green means you know though
...
like that so there we have it that's what we have that's what we showed so we
...
idea of what's going on ok so this first one when you plot the model what this
...
let's move on to the next one and again over time you'll get into what all this
...
scale location again at this one you just want to make sure that you want you
...
is that cooks distance right here see that little red line right here if
...
model to model three we're gonna compare
...
appreciate it and I will see you guys in the next lesson you [Music]End of file
