...
w3codecolor: false
draft: false
thumbnail: https://i.ytimg.com/vi_webp/bCLlT44WR4g/maxresdefault.webp
---

<a href="https://www.youtube.com/watch?v=bCLlT44WR4g">
<picture><img src="https://i.ytimg.com/vi_webp/bCLlT44WR4g/maxresdefault.webp"></picture>
</a>
...
everything out okay now in our it's a statistical it was built for
...
not a combination of both the power of R is that most of these functions can use
...
equal sign - but it's preferred to use the less ten - as to not get it confused
...
10 11 whatever we want to put in there these happen to be all integers now
...
normally you would do some 2 plus or 2 comma 2 and it would give you for some 3
...
and double check that it does 21 25 27 close enough 40 okay so that's cool that
...
of the assignment operator the right hand side is evaluated first and then it
...
so if I wanted to type in number 1 again I can just type in and you a more and
...
finally you can do things like communal it come you calm you looked have some I
...
sort number one it'll sort it by default lowest to highest now what we can do is
...
tab with the comma in there it'll actually bring it up it's the parameter list
...
digits after the decimal again you can start typing in round and once you hit
...
that'll help me grow my channel and continue creating videos like thisEnd of file
